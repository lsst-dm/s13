...
class Keys(object):
    ...
    ellipse_theta = schema.addField("ellipse.theta", type=lsst.afw.geom.Angle, doc="ellipse position angle")
...
def main(inputPath, outputPath):
    ...
    with open(inputPath, 'r') as inputFile:
        for n, line in enumerate(inputFile):
            ...
            record.setAngle(Keys.ellipse_theta, float(data[9]) * lsst.afw.geom.degrees)
